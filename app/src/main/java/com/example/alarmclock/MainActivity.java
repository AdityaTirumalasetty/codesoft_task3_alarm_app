...
public class MainActivity extends AppCompatActivity {
    ...
    private int hourValue, minuteOfHour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTimer.setOnClickListener(v -> {
            Alarm alarm = new Alarm(hourValue, minuteOfHour, true);
            alarms.add(alarm);
            saveAlarms(alarms); // Implement this method to save alarms in SharedPreferences
            alarmAdapter.notifyDataSetChanged();
            Toast.makeText(MainActivity.this, "Alarm Set for " + hourValue + " : " + minuteOfHour, Toast.LENGTH_SHORT).show();
            setTimer();
            notification();
        });
    }
    ...
    private void setTimer() {
        ...
        // Schedule alarms based on the Alarm objects in your list
        for (Alarm alarm : alarms) {
            if (alarm.isEnabled()) {
                // Create and set PendingIntent for each alarm
